...
use Square\FormElementPopulator; // interface

class Catalog_Form_ItemCreate extends Zend_Form {
    
   protected $multiSelectRetriever; 
   protected $country_entities;
            
   public function __construct(\Square\FormElementOptionsRetrieval $retriever)
   {
