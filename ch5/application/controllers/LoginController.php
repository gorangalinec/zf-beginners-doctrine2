...
class LoginController extends Zend_Controller_Action {
    ...
    {
       // create and/or validate the login form, which is in the forms folder.
       //--$form = new Square_Form_Login(); <-- origianl code.
 	  ...
 	  if ($form->isValid($this->getRequest()->getPost()) ) {
              ...
              if ($result->isValid()) {
                 ...
                 // If present, the requestURL is the url that requires a login before it can proceed. The preDispatch() method
                 //  of the Catalog_AdminItemController saves the requestURL in the 'square.auth' session namespace.
